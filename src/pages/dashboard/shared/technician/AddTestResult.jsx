        ...
        {testHistory.length === 0 ? (
          ...
          <>
            ...
            {completedSessions.length > 0 && (
              <>
                <h3 style={{ marginBottom: "12px" }}>Completed Sessions</h3>
                ...
                {completedSessions.map((session) => (
                  ...
                  >
                    <div
                      className="history-session-header history-session-top"
                      style={{ marginBottom: "12px" }}
                    >
                      <strong>{formatDateTime(session.test_date)}</strong>
                      ...
                      <div className="history-session-actions">
                        <Button
                          ...
                          btnClick={() => handleDownloadCsv(session)}
                        />
                        ...
                        <Button
                          ...
                          btnClick={() => handleDownloadPdf(session.history_id)}
                        />
                      </div>
                    </div>
                            ...
                            <tbody>
                              {(session.results || []).map((item, index) => {
                                ...
                                return (
                                  ...
                                  >
                                    <td className="history-table-test-name">
                                      {tt.name || item.test_name || "Test"}
                                    </td>

                                    <td
                                      className="history-table-result"
