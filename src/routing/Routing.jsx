    ...
    <Routes>
      ...
      {role === "ADMIN" && (
        <>
          ...
          <Route path="/technician/:technician_id" element={<TechnicianDetails />} />

          <Route path="/devices" element={<Devices />} />

          <Route path="/device/:device_id" element={<DevicesDetails />} />

          <Route path="/devices/assign/:device_id" element={<AssignDeviceTechnician />} />
      ...
      {role === "TECHNICIAN" && (
        <>
          ...
          <Route path="/technician/patient/:patient_id" element={<PatientDetails />} />

          <Route path="/technician/create-patient" element={<CreatePatient />} />

          <Route path="/technician/add-test-result/:reference_id" element={<AddTestResult />} />

          <Route path="/technician/start-test/:history_id" element={<EditTestResult />} />

          <Route path="/technician/uart-console" element={<UARTConsole />} />
          
          <Route path="/technician/profile" element={<Profile />} />

          <Route path="/technician/incubator-grid" element={<IncubatorGrid />} />
